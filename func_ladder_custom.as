...
namespace func_ladder_custom
{
    ...
    void func_ladder_custom_init()
    {
        ...
        while( ( @self = g_EntityFuncs.FindEntityByClassname( self, "func_ladder" ) ) !is null )
        {
            ...
            {
                string rendermode = g_Util.CKV( self, '$s_rendermode' );
                string renderamt = g_Util.CKV( self, '$s_renderamt' );
                string rendercolor = g_Util.CKV( self, '$s_rendercolor' );
                string renderfx = g_Util.CKV( self, '$s_renderfx' );
                ...
                {
                    self.pev.rendercolor = g_Util.atov( rendercolor );
                }
            }
        }
    }
