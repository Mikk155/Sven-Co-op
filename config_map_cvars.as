...
namespace config_map_cvars
{
    void Register()
    {
        g_Util.CustomEntity( 'config_map_cvars' );

        g_ScriptInfo.SetInformation
        ( 
            g_ScriptInfo.ScriptName( 'config_map_cvars' ) +
            g_ScriptInfo.Description( 'Expands trigger_setcvar entity.' ) +
    ...
    class config_map_cvars : ScriptBaseEntity, ScriptBaseCustomEntity
    {
        ...
        void Store( string m_iszKey )
        {
            ...
            {
                g_Util.CKV( self, '$s_' + m_iszKey, g_EngineFuncs.CVarGetString( m_iszKey ) );
