...
namespace trigger_manager
{
    void Register()
    {
        g_Util.CustomEntity( 'trigger_manager' );
    ...
    class trigger_manager : ScriptBaseEntity, ScriptBaseCustomEntity
    {
        ...
        void Use( CBaseEntity@ pActivator, CBaseEntity@ pCaller, USE_TYPE useType, float flValue )
        {
            ...
            {
                g_Util.CKV( pActivator, "$i_fireonce_" + self.entindex(), 0 );
                return;
            }
            ...
            if( spawnflag( ONCE_PER_PLAYER ) and atoi( g_Util.CKV( Eactivator.GetEntity(), "$i_fireonce_" + self.entindex() ) ) == 1 )
            {
                return;
            }

            g_Util.Trigger( strTarget, Eactivator.GetEntity(), Ecaller.GetEntity(), g_Util.itout( m_iUseType, useType ), m_fDelay );
            ...
            {
                g_Util.CKV( Eactivator.GetEntity(), "$i_fireonce_" + self.entindex(), 1 );
            }
