...
{
    class env_spritehud : ScriptBaseEntity, UTILS::MoreKeyValues
    {
        ...
        void Precache()
        {
            g_Game.PrecacheModel(  'sprites/' + string( sprite ).Replace( 'sprites/', '' ) );
            g_Game.PrecacheGeneric('sprites/' + string( sprite ).Replace( 'sprites/', '' ) );
            BaseClass.Precache();
        }
        ...
        void Spawn()
        {
            ...
            params.spritename = string( sprite ).Replace( 'sprites/', '' );
            BaseClass.Spawn();
        }
